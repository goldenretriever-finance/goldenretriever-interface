...
import { Currency, Pair } from '@goldenretriever-libs/sdk'
        ...
        {!hideInput && (
          <LabelRow>
            <RowBetween>
              ...
              {account && (
                <Text onClick={onMax} fontSize="14px" color="white" style={{ display: 'inline', cursor: 'pointer' }}>
