import { CurrencyAmount, JSBI, Token, Trade } from '@goldenretriever-libs/sdk'
                  ...
                  <AutoColumn gap="4px">
                    {Boolean(trade) && (
                      <RowBetween align="center">
                        <Text color="white" fontSize="14px">{TranslateString(1182, 'Price')}</Text>
                        <TradePrice
                    ...
                    {allowedSlippage !== INITIAL_ALLOWED_SLIPPAGE && (
                      <RowBetween align="center">
                        <Text color="white" fontSize="14px">{TranslateString(88, 'Slippage Tolerance')}</Text>
                        <Text color="white" fontSize="14px">{allowedSlippage / 100}%</Text>
                      </RowBetween>
                    )}
                  </AutoColumn>
                </Card>
